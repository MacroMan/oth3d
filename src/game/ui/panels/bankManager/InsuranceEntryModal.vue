<template>
  <BaseModal
    ...
    title-tag="h3"
    overlay-class="absolute inset-0 z-50 flex items-center justify-center bg-emergency-black/35 px-4 backdrop-blur-[2px]"
    panel-class="w-full max-w-lg rounded-3xl border-4 border-emergency-blue bg-emergency-white p-6 text-ui-text shadow-[0_12px_0_#2b2d42,0_18px_30px_rgba(0,0,0,0.22)]"
